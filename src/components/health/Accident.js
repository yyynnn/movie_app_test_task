...
import { health, correction, vectorPrev, vectorNext } from "../../img/indexImage";
		...
		<div className="col-lg-12 mx-auto wrap">
			<Container>
				<div className="title">
					...
					<h2 className="title-text-form title-text colorTextLightGray text-center ">Accident</h2>
				</div>
					...
					<form>
						<div className="wrap-info">
							...
							<label className="input-text">
								...
								<input name="damaged-accident" type="text" placeholder="Assembly table" />
							</label>
						</div>
