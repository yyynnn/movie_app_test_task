...
import { health, vectorNext, vectorPrev, correctionUse } from "../../img/indexImage";
		...
		<div className="col-lg-12 mx-auto wrap">
			<Container>
				<div className="title">
					...
					<h2 className="title-text title-text-form colorTextLightGray text-center ">Nearmiss</h2>
				</div>
					...
					<form>
						<div className="wrap-info">
							...
							<div className="select-wrapper">
								<label className="select" >
									<span>foreman</span>
									<select className="select" id="foreman" name="foreman-nearmiss">
							...
							<label className="input-text">
								...
								<input type="text" name='text-nearmiss' placeholder="Combilift 12t" />
							</label>
						</div>
