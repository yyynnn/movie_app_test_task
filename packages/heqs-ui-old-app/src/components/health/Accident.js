...
const Accident = ({ selectedTicketData }) => {
  ...
  function handleCloseModal() {
    const elementModal = document.getElementById(selectedTicketData ? 'ticketModal' : 'accident')
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="wrap-file">
                  <label className="file flex">
                    ...
                    />
                    {selectedFile && (
                      <img className="w-100 h-100 borderRounded" src={selectedFile} alt="preview" />
                    )}
                    {!selectedFile && errors.selectedFile && touched.selectedFile && (
                      <p className="error mt-1 errorFile mb-0">{errors.selectedFile}</p>
                    )}
                  </label>
                ...
                <button className="button submmit my-3" type="submit" data-bs-dismmiss="modal">
                  Submit
                </button>
              </form>
            </div>
