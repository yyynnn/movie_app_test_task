        ...
        <Container>
          <div className="wrap">
            ...
            <div className="d-grid gap-4 d-sm-flex justify-content-sm-center btn-wrap">
              <button id="Accident" className="button environment">
                Accident
              </button>
              <button id="Nearmiss" className="button environment">
                Nearmiss
              </button>
              <button id="Possible_accident" className="button environment">
                Possible accident
              </button>
            </div>
